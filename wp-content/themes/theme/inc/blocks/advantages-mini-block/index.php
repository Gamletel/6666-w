...
class AdvantagesMiniBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'advantages-mini-block',
				'title'             => 'Блок: Преимущества (мини)',
				'description'       => 'Преимущества компании (мини)',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/advantages-mini-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/advantages-mini-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
...
return new AdvantagesMiniBlock();
?>