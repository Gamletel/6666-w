...
class PayDeliveryBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'pay-delivery-block',
				'title'             => 'Блок: Оплата и доставка',
				'description'       => 'Оплата и доставка товаров',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/pay-delivery-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/pay-delivery-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
