...
class TextBigBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'text-big-block',
				'title'             => 'Блок: Текст (без изображения)',
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/text-big-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/text-big-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
